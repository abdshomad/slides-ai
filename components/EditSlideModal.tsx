    ...
    >
      ...
      >
        <div className="flex justify-between items-start mb-4">
            <h2 id="edit-slide-title" className="text-2xl font-bold text-pink-600 dark:text-pink-400">Edit Slide</h2>
            <button onClick={onClose} className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-white" aria-label="Close">
                &times;
            </button>
        </div>
        ...
        <form onSubmit={handleSave}>
          <label htmlFor="edit-prompt" className="block text-lg font-semibold text-slate-700 dark:text-slate-300 mb-2">
